...
def remover(nome, cliente):
    if nome in clientes:
        ...
        clientes[nome][0].send("Voce desconectou-se do chat.".encode('utf-8')) #print para o cliente
...
def lidar_com_cliente(cliente):
    ...
    if nome not in clientes:
        ...
        conexao_data.send("Voce conectou-se ao chat.".encode('utf-8')) #print para o cliente
